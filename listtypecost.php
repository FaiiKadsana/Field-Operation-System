...
If ($pri == '100' || $pri == '80') {
    If ($sortfield == "") {
        $str = "select *  from list t1 left join type_cost t2 on t1.id_type_cost = t2.id_type_cost where (t1.tripid = '$tripid') and (t1. id_type_cost='$id_type_cost')  order by date_list  ";
    } else {
        $str = " select *  from list t1 left join type_cost t2 on t1.id_type_cost = t2.id_type_cost where (t1.tripid = '$tripid') and (t1. id_type_cost='$id_type_cost')  order by t1.$sortfield $sort   ";
    }
} else {
    If ($sortfield == "") {
        $str = "select *  from list t1 left join type_cost t2 on t1.id_type_cost = t2.id_type_cost where (t1.tripid = '$tripid') and (t1. id_type_cost='$id_type_cost') and (t1.userid = '$userid') order by date_list  ";
    } else {
        $str = " select *  from list t1 left join type_cost t2 on t1.id_type_cost = t2.id_type_cost where (t1.tripid = '$tripid') and (t1. id_type_cost='$id_type_cost') and (t1.userid = '$userid') order by t1.$sortfield $sort   ";
    }
}// end if privilage
