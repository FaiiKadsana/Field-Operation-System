                                    ...
                                    <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#333333">
                                        ...
                                        <tr valign="middle" align="right">
                                            ...
                                            <td height="32">&nbsp;&nbsp;
                                                ...
                                                <input style="width:80px;" type="submit" name="send" value="บันทึก" onMouseOver="daily_allowance();"  <?= ( $display == true) ? 'disabled' : ''; ?>>
                    ...
                    $.ajax({
                        ...
                        success: function(json) {
                            ...
                            $.each(json, function(key, value) {
                                $('#task_id').append($('<option class="' + value['CostId'] + '"></option>').val(value['TaskId']).html(value['TaskId']));
                            });
                            $('#cost_id').val(0);
                        },
                        error: function() {
                    ...
                    success: function(json) {
                        ...
                        $.each(json, function(key, value) {
                            if (<?php echo $rs[task_id]; ?> == value['TaskId']) {
                                $('#task_id').append($('<option class="' + value['CostId'] + '" selected></option>').val(value['TaskId']).html(value['TaskId']));
                            } else {
                                $('#task_id').append($('<option class="' + value['CostId'] + '"></option>').val(value['TaskId']).html(value['TaskId']));
                            }
                        });
