...
if ($_SERVER[REQUEST_METHOD] == "POST"){
			...
			If ($tripname ==''){	exit();	}
			 ...
			 if ($_POST[action]=="edit2"){
				...
				mysql_query($update_downline_del);
            ...
            <table width="100%" border="0" align="center" cellpadding="1" cellspacing="2" bgcolor="#FFFFFF">
              ...
              <tr>
				...
				<?php echo GetTripOwner($tripid);?>
				  ...
				  <?php ($_SESSION['avatar_mode'] == "on")?"<img src=\"images/16x16/video_camera.png\" width=\"16\" height=\"16\" ALT=\"AVATAR MODE\" TITLE=\"AVATAR MODE\">":"";?>
				  
                </strong>
                
				<?php $user_id = $_SESSION[userid_origin] ? $_SESSION[userid_origin] : $_SESSION[userid]?>
                
    			<a href="<?php echo ($pri =='100' && ($user_id!='103' && $user_id!='140'))?"list_user.php":"add_user.php?action=edit&id=$user_id;"?>" target="_blank"><img src="images/16x16/toolbox.png" width="16" height="16" border="0" alt="<?php echo ($pri =='100')?"ปรับปรุง รายชื่อ User":"ปรับปรุง User ";?>"></a>
                <?php
                if($pri =='100'){
				?>
...
<!--            <tr><td align="right"><a href="list_user.php"><img src="images/16x16/monitor.png" width="16" height="16" border="0"><strong>usermanager</strong></a></td></tr>-->
            ...
            <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
              <tr>
                <td  align="left" style="background-color:#FFFFFF; display:<?php echo (($pri =='100' || $pri =='80')?"":"none");?>; "><nobr><a href="addtrip.php<?=$view != "all" ? "?view=all" : "?view=owner"?>"><img src="images/16x16/monitor.png" width="16" height="16" border="0">รายงาน<?=$view != "all" ? "ทั้งหมดทุกคน" : "ส่วนบุคคล"?></a></td>
              ...
              <tr>  
				...
				<table width="95%" border="0" align="center" cellpadding="1" cellspacing="5">
                  ...
                  <tr>
                    ...
                    <td style="background-color:#FFFFFF"><nobr>&nbsp;<a href="?close=y&showall=&year_r=<?=$year_r?>&view=<?=$view?>">ผ่านการตรวจรับเอกสาร รอการอนุมัต0ิ</a>&nbsp;</td>
                    </tr>
                  <tr>
...
?>
       ...
       <?php
		...
		//	$_SESSION[userid] = $rsx[userid] ;
			...
			?>
                ...
                $strCashHeader = "SELECT COUNT(tripid) AS count_trip
							...
							$resultCashHeader = mysql_query($strCashHeader);
		...
		$query_header = mysql_query($sql_header);	
		$arr_user = array();
		...
		*/
		$str_staff = "		
			SELECT  trip.tripid,trip.tripname,trip.note ,trip.trip_status,trip.userid
				...
				GROUP BY  trip.tripid ORDER BY  trip.tripid ;
			";	
		$query_staff = mysql_query($str_staff);	
		...
		?>
        	<TR bgcolor="<?php echo $bg;?>">
            	...
            	<td><?php echo $rowstaff['tripname'];?></td>
                <td><?php echo $rowstaff['note'];?></td>
            	<td align="center">
                 <?php
                $strCashHeader = "SELECT COUNT(tripid) AS count_trip
									FROM  trip 
							...
							if($row_header['count_trip']>0){
							  ...
							  ?>
                              <a href="report_cost_downline.php?tripid=<?php echo $rowstaff[tripid];?>&userid=<?php echo $rowstaff['userid'];?>">
                <img src="images/ico_register.gif" border="0" width="16" title="รายการค่าใช้จ่ายของลูกทีม" align="absmiddle"/></a>	&nbsp;&nbsp;
				<?php } ?>	
                </td>
            </TR>
			  ...
			  <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center">
                ...
                <tr>
				 ...
				 if($headeruser!=""){
					 ...
					 $query_headeru = mysql_query($sql_headeru);
