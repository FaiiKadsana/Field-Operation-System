...
if(isset($_SESSION['userid'])){
		echo 'check login'; print_r($_SESSION);
		//echo "<meta http-equiv='refresh' content='0' url='addtrip.php?showall=y'>" ;	
		echo "<script>window.location='addtrip.php?showall=y';</script>";
		die;
}else{
...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
	$sql = " select * from cos_user where  username = '".$_POST['user']."'  AND   password = '".$_POST['pass']."' limit 1";
